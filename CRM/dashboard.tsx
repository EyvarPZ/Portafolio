        ...
        <header className="flex items-center justify-between py-4 border-b border-slate-700/50 mb-6">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Avatar>
                <AvatarImage src="/images/human-avatar.png" alt="User Avatar" />
...
function CommunicationItem({
  ...
  time,
  message,
  avatar = "/images/human-avatar.png", // Valor por defecto actualizado
  unread,
}: {
  sender: string
  time: string
  message: string
  avatar?: string // Hacer opcional con valor por defecto
  unread?: boolean
}) {
  return (
